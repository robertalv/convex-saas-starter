    ...
    <section className="mt-[60px] lg:mt-[180px] min-h-[530px] relative lg:h-[calc(100vh-300px)]">
      <div className="flex flex-col">
        ...
        <h2 className="mt-6 md:mt-10 max-w-[580px] text-[#878787] leading-tight text-[24px] md:text-[36px] font-medium">
          Real time updates, multiple organizations, User Invitations, Session tracking, Clients, Projects & an AI assistant for <WordAnimation />
        </h2>

        <div className="mt-8 md:mt-10">
          <div className="flex items-center space-x-4">
            <Link
              href="https://github.com/robertalv/convex-saas-starter"
              target="_blank"
            ...
            <a href="https://convex-starter.devwithbobby.com">
              <Button className="h-11 px-5">Demo</Button>
            </a>
          </div>
        </div>

        <p className="text-xs text-[#707070] mt-4 font-mono">
          Start building your SaaS app in minutes.
        </p>
      </div>
